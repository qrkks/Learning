...
function NavList() {
  ...
  return (
    <List className="p-0 mt-4 mb-6 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
      <ListItem className="flex items-center gap-2 py-2 pr-4" onClick={ () => router.push("/")}>
        {/* <Link href="/"> */}
      ...
      <ListItem className="flex items-center gap-2 py-2 pr-4" onClick={ () => router.push("/meals")}>
        {/* <Link href="/meals"> */}
          <Typography variant="small" color="blue-gray" className="font-medium">
            Meals
          </Typography>
